# [Risk of Rain 2 Fun House] - v27.2 (The Stabilizer Release)
# Description: Crash Reporting, Memory Anchors, Directory Pre-Check.
...
# --- CRASH HANDLER ---
# Captures startup errors to a file so we can see why it crashes
def log_crash(e):
...
try:
    ...
    HEADERS = {"User-Agent": "ROR2-FunHouse/27.2 (Stabilizer)"}
    ...
    INTERNAL_ID_MAP = {
        ...
        "Hardlight Afterburner": "UtilitySkillMagazine", "Wake of Vultures": "HeadHunter",
        "Brainstalks": "KillEliteFrenzy", "Resonance Disc": "LaserTurbine", "Interstellar Desk Plant": "Plant",
        "Ben's Raincoat": "ImmuneToDebuff", "Pocket I.C.B.M.": "MoreMissile", "Spare Drone Parts": "DroneWeapons",
        "Symbiotic Scorpion": "PermanentDebuffOnHit", "Aegis": "BarrierOnOverHeal",
        "Shattering Justice": "ArmorReductionOnHit", "Unstable Tesla Coil": "ShockNearby",
        "Bottled Chaos": "RandomEquipmentTrigger", "Defensive Microbots": "CaptainDefenseMatrix",
        "Laser Scope": "CritDamage",

        # BOSS (Yellow)
        "Titanic Knurl": "Knurl", "Queen's Gland": "BeetleGland", "Little Disciple": "SprintWisp",
        "Genesis Loop": "NovaOnLowHealth", "Molten Perforator": "FireballsOnHit",
        "Shatterspleen": "BleedOnHitAndExplode", "Mired Urn": "SiphonOnLowHealth",
        "Charged Perforator": "LightningStrikeOnHit", "Empathy Cores": "RoboBallBuddy",
        "Planula": "ParentEgg", "Defense Nucleus": "MinorConstructOnKill", "Halcyon Seed": "TitanGoldDuringTP",

        # LUNAR (Blue)
        "Shaped Glass": "LunarDagger", "Brittle Crown": "GoldOnHit", "Transcendence": "ShieldOnly",
        "Corpsebloom": "RepeatHeal", "Gesture of the Drowned": "AutoCastEquipment",
        "Focused Convergence": "FocusConvergence", "Purity": "LunarBadLuck",
        "Light Flux Pauldron": "HalfAttackSpeedHalfCooldowns", "Stone Flux Pauldron": "HalfSpeedDoubleHealth",
        "Eulogy Zero": "RandomlyLunar", "Egocentrism": "LunarSun", "Mercurial Rachis": "RandomDamageZone",
        "Beads of Fealty": "LunarTrinket", "Defiant Gouge": "LunarSecondaryReplacement",
        
        # VOID (Purple)
        "Safer Spaces": "BearVoid", "Needletick": "BleedOnHitVoid", "Lost Seer's Lenses": "CritGlassesVoid",
        "Weeping Fungus": "MushroomVoid", "Encrusted Key": "TreasureCacheVoid",
        "Polylute": "ChainLightningVoid", "Plasma Shrimp": "MissileVoid", "Tentabauble": "SlowOnHitVoid",
        "Benthic Bloom": "CloverVoid", "Singularity Band": "ElementalRingVoid",
        "Pluripotent Larva": "VoidMan", "Lysate Cell": "EquipmentMagazineVoid",
        ...
        "Helfire Tincture": "BurnNearby", "Remote Caffeinator": "VendingMachine"
    }
    ...
    class App(ctk.CTk):
        ...
        def _inj(self):
            ...
            for i, v in self.sel_i.items():
                if v["chk"].get():
                    try: 
                        if int(v["qty"].get()) > 0: cmds.append(f"give_item {i} {v['qty'].get()}")
                    except: pass
